...
if [[ "$PARAMETER" =~ "uninstall" ]]; then
	...
	sudo cp ./iPhoneOS.platform/libstdc++* /Applications/Xcode.app/Contents/Developer/Platforms/iPhoneOS.platform/Developer/Library/CoreSimulator/Profiles/Runtimes/iOS.simruntime/Contents/Resources/RuntimeRoot/usr/lib/
